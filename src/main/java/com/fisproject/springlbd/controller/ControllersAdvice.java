...
public class ControllersAdvice extends ResponseEntityExceptionHandler {
    ...
    Logger log = LoggerFactory.getLogger(ControllersAdvice.class);

    @ExceptionHandler(RuntimeException.class)
    public ResponseEntity<StandardResponse> handleRuntimeException(RuntimeException ex) {
        StandardResponse errorResponse = new StandardResponse(HttpStatus.BAD_REQUEST, "Runtime Exception", ex);
    ...
    public ResponseEntity<StandardResponse> handleConstraindViolationException(ConstraintViolationException ex) {
        StandardResponse errorResponse = new StandardResponse(HttpStatus.BAD_REQUEST, "Validation error");
