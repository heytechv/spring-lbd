...
public class Sprint {
    ...
    private Set<UserStory> userStorySet = new HashSet<>();
    ...
    // --
    public void addUserStory   (UserStory userStory) { this.userStorySet.add(userStory); userStory.getSprintSet().add(this); }
    public void removeUserStory(UserStory userStory) { this.userStorySet.remove(userStory); userStory.getSprintSet().remove(this); }
